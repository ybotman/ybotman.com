...
<!-- wp:paragraph {"align":"center","customBackgroundColor":"#d6f3ff","fontSize":"medium"} -->
...
<!-- wp:image {"align":"right","id":626,"width":353,"height":127} -->
...
<!-- wp:image {"align":"right","id":625,"width":346,"height":255} -->
...
<!-- wp:image {"align":"left","id":629,"width":290,"height":306} -->
<div class="wp-block-image"><figure class="alignleft is-resized"><img src="https://ybotman.com/wp-content/uploads/Harmonics-wave.png" alt="" class="wp-image-629" width="290" height="306"/><figcaption>Don't worry about the math. Just think a double, triple, quadricple, etc of the frequency.</figcaption></figure></div>
<!-- /wp:image -->

<!-- wp:paragraph {"dropCap":true} -->
<p class="has-drop-cap"><strong>Harmonic Series</strong>&nbsp;is the sequence of pure sinusoidal tones, in which the frequency&nbsp;of each sound is a&nbsp;multiple of the lowest frequency (or fundamental). This is measured in cps (cycles per second or Hz (Hertz). These measures are identical : cps = Hz.  So, in the above example, 1 wave per second (1Hz) is the fundamental and is also 1 Hz. The  the first harmonic is 2x or 2Hz, the second karmic is 3Hz, etc.  If the above fundamental was 9hz, then the first harmonic would be 18Hz, and the second would e 27Hz, the third would be 36Hz, etc.</p>
<!-- /wp:paragraph -->

<!-- wp:image {"align":"right","id":630,"width":412,"height":343} -->
<div class="wp-block-image"><figure class="alignright is-resized"><img src="https://ybotman.com/wp-content/uploads/Spectrogram_showing_shared_partials.png" alt="" class="wp-image-630" width="412" height="343"/><figcaption>2 "pitches" (going left to right) with the harmonic series (going vertical) in a spectrogram.</figcaption></figure></div>
<!-- /wp:image -->

<!-- wp:paragraph {"dropCap":true} -->
<p class="has-drop-cap"><strong>Spectrograms </strong>display a visual representation of the spectrum of frequencies of sound as they vary with time.&nbsp;The orange spectrogram example shows 2 pitches (a low, then a high pitch) played one after another (going left to right), producing a dozen or more of the harmonic series. The fundamental pitches are at the bottom-most bright lines, with the other harmonics (1st to 15th and more ) going <em>up </em>the graph. A spectrogram is great tool to see sound frequencies, the fundamental and its harmonic series. </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><strong>When sounds are generated </strong>by much of the stuff in the world around us (voices, trombone, violins, bells, car engine, or a dropped fork) also simultaneously generate, a generous harmonic series (each on a multiple of the fundamental). So, a single note played from a Trombone produces a dozen (and more) pitches. But we don't really hear these notes as separate distinct notes. Read on.</p>
<!-- /wp:paragraph -->

<!-- wp:image {"align":"left","id":634,"width":233,"height":157} -->
<div class="wp-block-image"><figure class="alignleft is-resized"><img src="https://ybotman.com/wp-content/uploads/image-30.png" alt="" class="wp-image-634" width="233" height="157"/></figure></div>
<!-- /wp:image -->

<!-- wp:image {"align":"right","id":654,"width":141,"height":147} -->
<div class="wp-block-image"><figure class="alignright is-resized"><img src="https://ybotman.com/wp-content/uploads/image-35.png" alt="" class="wp-image-654" width="141" height="147"/></figure></div>
<!-- /wp:image -->

<!-- wp:paragraph -->
<p><strong>Now here's is what is amazing: </strong> When it comes to the hearing the <em>harmonic series played together</em>, OUR BRAINS<strong> DO NOT HEAR</strong> them as INDIVIDUAL PITCHES - it only identifies the LOWEST note (which is the fundamental) as the PITCH.  Let me re-phrase: If I play the a set of 20 pure sinusoidal notes (all harmonic series related) from 20 different speakers, you will only hear 1 low note. Yes, your brain will <strong>not be able </strong>to distinguish the other 19 pitches.  Its a little like how you can't see Blue mixed with Yellow paint as a<em> Blueish-Yellow,</em> but your brain sees a <em>green</em>. While your brain does not hear the non-fundamental parts of a harmonic series as individual tones, it doesn't ignore them . . . </p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center","customBackgroundColor":"#bbebff","fontSize":"medium"} -->
<p style="background-color:#bbebff" class="has-background has-text-align-center has-medium-font-size"><strong>OK, now we can talk about what a vowel is.</strong>  </p>
<!-- /wp:paragraph -->
...
<!-- wp:image {"align":"right","id":643,"width":433,"height":238} -->
...
<!-- wp:image {"align":"left","id":645,"width":367,"height":273} -->
...
<!-- wp:image {"align":"left","id":642,"width":353,"height":353} -->
...
<!-- wp:core-embed/vimeo {"url":"https://vimeo.com/352947397","type":"video","providerNameSlug":"vimeo","className":"wp-embed-aspect-18-9 wp-has-aspect-ratio"} -->
...
<!-- wp:image {"align":"left","id":651,"width":462,"height":380} -->
...
<!-- wp:paragraph {"customFontSize":21} -->
